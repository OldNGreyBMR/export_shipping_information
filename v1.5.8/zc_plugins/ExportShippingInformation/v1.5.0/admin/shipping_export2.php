 ...
 * Version: 1.5.0 2023-12-21 Convert to admin zc_plugins format; Renamed files to shipping_export2
*/
                                            ...
                                            <tr>
                                                <td valign="top">
                                                    ...
                                                    <table border="0" width="100%" cellspacing="2" cellpadding="0">
                                                        ...
                                                        while (!$order->EOF) {
                                                            list(
                                                                $order_id, $cust_email, $delivery_name, $delivery_company, $delivery_street,
                                                                $delivery_suburb, $delivery_city, $delivery_postcode, $delivery_state,
                                                                $delivery_country, $shipping_method, $customers_telephone, $order_total
                                                            )
                                        ...
                                        <table border="0" width="100%" cellspacing="0" cellpadding="2">
                                            <tr class="infoBoxHeading">
                                                <td class="infoBoxHeading">
                                                    <b><?php echo HEADING_ADDITIONAL_FIELDS_TITLE; ?></b>
                                                </td>
                                            </tr>
                                        </table>
                                        <table border="0" width="100%" cellspacing="0" cellpadding="2">
                                                    ...
                                                    <form name="download_csv" id="download_csv" method="post">
                                                        ...
                                                        <table border="0" cellspacing="0" cellpadding="2">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <!-- <td><?php //echo zen_draw_pull_down_menu('order_status', $status_array, $_POST['order_status'], 'id="order_status"');
                                                                            ?></td>  BMH // -->
                                                            </tr>
                                                        </table>
                                                        <hr>
