 ...
 */
//  $Id: lang.shipping_export.php  2025-02-15 Piloujp $
...
$define = [
    ...
    'TEXT_PREVIOUS_EXPORTS' => 'Include Previously Exported Orders. By default the export file includes only those orders that have not already been exported. If you wish to include orders from date ranges that have already been downloaded, then you should checkbox the selection below. Combine this feature with the date range feature for even more flexibility.',
